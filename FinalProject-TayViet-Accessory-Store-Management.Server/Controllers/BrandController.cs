...
namespace FinalProject_TayViet_Accessory_Store_Management.Controllers
{
    ...
    [ApiController]
    [Route("api/[controller]")]
    public class BrandController : ControllerTemplate<Brand>
    {
        public BrandController(BrandDatabaseServices brandDatabaseServices) : base(databaseServices: brandDatabaseServices) { }
    }
}